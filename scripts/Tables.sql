...
CREATE TABLE ESTATUS_PP_SOLICITUD (
	...
	CONSTRAINT fk_pzb FOREIGN KEY (fk_zon_id, fk_edz_id, fk_pru_id) REFERENCES PRUEBA_PIEZA_SOLICITUD(fk_zon_id, fk_edz_id, fk_pru_id) ON DELETE CASCADE,
	CONSTRAINT fk_est_id FOREIGN KEY (fk_est_id) REFERENCES ESTATUS(est_id) ON DELETE CASCADE
);
...
CREATE TABLE SOLICITUD_CLIENTE (
	...
	CONSTRAINT fk_cjd_id FOREIGN KEY (fk_cjd_id) REFERENCES CLIENTE_JURIDICO(cjd_id) ON DELETE CASCADE,
	CONSTRAINT fk_ctn_id FOREIGN KEY (fk_ctn_id) REFERENCES CLIENTE_NATURAL(ctn_id) ON DELETE CASCADE,
	CONSTRAINT fk_avi_id FOREIGN KEY (fk_avi_id) REFERENCES AVION_CREADO(avi_id) ON DELETE CASCADE
);
