...
const columns = [
    ...
    { key: 'per_experiencia', label: 'Experiencia', format: (value) => `${value} años` },
...
const formFields = [
    ...
    { name: 'per_experiencia', label: 'Experiencia (años)', type: 'number', required: true },
    { name: 'per_profesion', label: 'Profesión', type: 'text', required: true },
    { name: 'fk_lug_id', label: 'Lugar', type: 'select', required: true, options: [] }
]
